/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 90f70f6d7cb8256841aa4f0400ea1e3a)
...
interface __BaseEnv_Env {
	...
	MEADOW: DurableObjectNamespace<import("./apps/cloudflare/worker").MeadowContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./apps/cloudflare/worker");
		durableNamespaces: "MeadowContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GAME_NAMESPACE" | "LEGACY_NAMESPACE" | "WEB_ORIGINS" | "CANONICAL_HOST">> {}
}

...
- Use strict versioned JSON, 8 KiB inbound frames, latest movement intent at 20 Hz, server simulation at 20 Hz and full snapshots at 10 Hz. Full-only snapshots deliberately remove delta-base complexity for two players; reject delta/old-epoch messages and request a full resync.

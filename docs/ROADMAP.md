...
| M1 Authoritative multiplayer | M0 passed; Astra High designs, Medium implements | Two independent clients in one room, input validation, interpolation/reconciliation, Redis hot recovery; host lifecycle/failover spike passes | No gathering, combat or Postgres gameplay persistence |
...
| M6 Durable cooperative release | M5 gameplay accepted; Astra High designs, Medium implements | Postgres transactions, stable identity binding, inventory/companion/world recovery, four-player load check | No economy, multi-region writers or complex accounts product |
